...
-- Tiempo de generación: 24-09-2025 a las 01:39:36
...
--
-- Base de datos: `placeres_ocultos`
--
...
CREATE TABLE `cliente` (
  ...
  `tipo_documento` enum('cc','ti','dni','pasaporte','otro') COLLATE utf8mb4_unicode_ci DEFAULT 'cc',
...
CREATE TABLE `pedido` (
  ...
  `telefono_entrega` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
